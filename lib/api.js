...
function intToRGB(i) {
  ...
  return {
    bg: `rgb(${parseInt(result[0], 16)},${parseInt(result[1], 16)},${parseInt(result[2], 16)})`,
    fore: `rgb(${255 - parseInt(result[0], 16)},${255 - parseInt(result[1], 16)},${255 - parseInt(result[2], 16)})`
  };
}