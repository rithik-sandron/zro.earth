...
import dev__myWayToApproachANewLanguageMd from './dev__my-way-to-approach-a-new-language.md.json' assert { type: 'json' }
import anime__animeSeriesForBeginnersMd from './anime__anime-series-for-beginners.md.json' assert { type: 'json' }

export const allBlogs = [dev__javaPart_1Md, dev__javaPart_2Md, dev__javaPart_3Md, dev__linuxBasicsMd, dev__myWayToApproachANewLanguageMd, anime__animeSeriesForBeginnersMd]
